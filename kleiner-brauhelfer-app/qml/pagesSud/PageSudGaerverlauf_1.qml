...
PageBase {
    ...
    component: ColumnLayout {
        ...
        Popup {
            ...
            function openIndex(index) {
                if (!page.readOnly) {
                    ...
                    tfDate.date = Brauhelfer.sud.modelSchnellgaerverlauf.data(index, "Zeitstempel")
                    tfSW.value = Brauhelfer.sud.modelSchnellgaerverlauf.data(index, "SW")
                    tfDensity.value = Brauhelfer.calc.platoToDichte(tfSW.value)
                    tfTemp.value = Brauhelfer.sud.modelSchnellgaerverlauf.data(index, "Temp")
                    valueChanged = false
                    open()
                }
            }
            ...
            onClosed: {
                if (popupEdit.valueChanged && !isNaN(tfDate.date)) {
                    Brauhelfer.sud.modelSchnellgaerverlauf.setData(popupEdit.index,
        ...
        FloatingButton {
            ...
            onClicked: {
                Brauhelfer.sud.modelSchnellgaerverlauf.append()
